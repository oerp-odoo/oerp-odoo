...
class TestInvoice3plOrder(TransactionCase):
    ...
    def test_04_invoice_3pl_order_invoice_state_target_paid_via_shipment_status(self):
        # GIVEN
        ...
        with patch.object(
            ...
            self.TplSaleOrder.sync_shipment_status(self.sale_1)
        # THEN
        invoice = self.sale_1.invoice_ids
        self.assertEqual(len(invoice), 1)
        self.assertEqual(invoice.state, 'posted')
    ...
    def test_05_invoice_3pl_order_invoice_state_email_open(self):
        # GIVEN
        self.tpl_service_demo_1.write(
    ...
    def test_06_invoice_3pl_order_invoice_state_email_paid(self):
        # GIVEN
        self.tpl_service_demo_1.write(
            {'invoice_state_target': 'paid', 'invoice_state_email': 'paid'}
        )
    ...
    def test_07_invoice_3pl_order_invoice_state_email_paid_inv_not_paid(self):
        # GIVEN
        self.tpl_service_demo_1.write(
