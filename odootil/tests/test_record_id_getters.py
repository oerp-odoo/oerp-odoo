...
from ..tools import record as rutils
from . import common


class TestRecordIdGetters(common.TestOdootilCommon):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_01_get_record_id_by_domain_match(self):
        # WHEN
        partner_id = rutils.get_record_id_by_domain(
    ...
    def test_02_get_record_id_by_domain_no_match(self):
        ...
        with self.assertRaisesRegex(ValidationError, r"No Contact found using domain"):
            rutils.get_record_id_by_domain(self.ResPartner, domain=[('id', '=', 0)])
    ...
    def test_03_get_record_id_by_name_match_multi(self):
        ...
        with self.assertRaisesRegex(ValidationError, r"Found more than one record"):
            rutils.get_record_id_by_domain(
                self.ResPartner,
    ...
    def test_04_get_record_id_by_name_match(self):
        # WHEN
        partner_id = rutils.get_record_id_by_name(
    ...
    def test_07_validate_record_exists_n_active(self):
        self.assertEqual(rutils.validate_record_exists(self.partner_1), '')

    def test_08_validate_record_exists(self):
        self.assertEqual(rutils.validate_record_exists(self.country_lt), '')
    ...
    def test_09_validate_record_not_exists(self):
        ...
        with self.assertRaisesRegex(
            ...
            rutils.validate_record_exists(self.ResPartner)
    ...
    def test_10_validate_record_not_active(self):
        ...
        with self.assertRaisesRegex(
            ...
            rutils.validate_record_exists(self.partner_1)
