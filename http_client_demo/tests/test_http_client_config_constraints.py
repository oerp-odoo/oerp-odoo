...
class TestHttpClientConfigConstraints(common.TestHttpClientDemoCommon):
    ...
    def test_01_http_client_config_incorrect_log_status_code_filter(self):
        with self.assertRaisesRegex(ValidationError, r"Invalid expression:"):
            self.config_1.log_status_code_filter = '100,abc'

    def test_02_http_client_config_wrong_controller_model(self):
