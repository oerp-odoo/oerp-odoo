...
class TestFiscalPositionCompanyType(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.partner_individual = cls.ResPartner.create(
            {'name': 'Individual 1', 'is_company': False, 'country_id': country_id}
        )
    ...
    def test_01_get_fiscal_position(self):
        ...
        """
        # Case 1.
        fp = self.AccountFiscalPosition.get_fiscal_position(self.partner_azure.id)
    ...
    def test_02_get_fiscal_position(self):
        ...
        """
        fp = self.AccountFiscalPosition.get_fiscal_position(self.partner_individual.id)
    ...
    def test_03_get_fiscal_position(self):
        ...
        """
        fp = self.AccountFiscalPosition.get_fiscal_position(
            self.partner_azure.id, delivery_id=self.partner_individual.id
        )
        self.assertEqual(fp, self.fp_person)
